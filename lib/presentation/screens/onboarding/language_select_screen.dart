...
class SelectLanguageScreen extends StatefulWidget {
  final bool isBack;
  const SelectLanguageScreen({required this.isBack, super.key});
...
class _SelectLanguageScreenState extends State<SelectLanguageScreen>
  ...
  final List<Map<String, dynamic>> localeList = [
    ...
    {"name": "ქართული (Georgian)", "locale": "ka", "flag": "🇬🇪"},
  ];
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                Text(
                  "Select your preferred language to continue".translate(
                    context,
                  ),
                  style: TextStyle(
                    fontSize: 15,
                        ...
                        return AnimatedContainer(
                          ...
                          child: ListTile(
                            ...
                            onTap: () {
                              ...
                              context.read<LCodeCubit>().changeLanguage(
                                localeList[index]['locale'],
                              );
                            },
                          ),
