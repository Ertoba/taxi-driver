...
@objc class AppDelegate: FlutterAppDelegate, CLLocationManagerDelegate {
    ...
    override func application(
        ...
        // Initialize Google Maps with the locally supplied, bundle-restricted key.
        guard let mapsAPIKey = Bundle.main.object(forInfoDictionaryKey: "GMSApiKey") as? String,
              !mapsAPIKey.isEmpty,
              !mapsAPIKey.contains("$(") else {
            fatalError("GOOGLE_MAPS_API_KEY is missing from the iOS build configuration.")
        }
        ...
        let bubbleChannel = FlutterMethodChannel(name: "ge.mili.taxi.driver/floating_bubble", binaryMessenger: controller.binaryMessenger)
        ...
        let ringtoneChannel = FlutterMethodChannel(name: "ge.mili.taxi.driver/ringtone", binaryMessenger: controller.binaryMessenger)
    ...
    func locationManager(_ manager: CLLocationManager, didUpdateLocations locations: [CLLocation]) {
        ...
        let channel = FlutterMethodChannel(name: "ge.mili.taxi.driver/floating_bubble", binaryMessenger: (window?.rootViewController as! FlutterViewController).binaryMessenger)
